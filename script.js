...
<body>
  <div class="container">
    ...
    <footer>
      <p>Made by: <a href="https://github.com/cidkardi" target="_blank">cidkardi</a> on Github</p>
      <p>Licenced under the <a href="https://github.com/cidkardi/edhack/blob/main/LICENSE" target="_blank">GNU GPL v3</a>.</p>
    </footer>
  </div>
</body>
</html>`;
